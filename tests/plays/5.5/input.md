# Play 5.5 — Build your team's capability-building plan · fixture input

**Consumes:** A6 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-open-learning-catalogue`
**Produces:** A30 — Capability-building plan
...
placeholder in brackets above. The named input is A6 of `tests/progressa.md`. Paste
