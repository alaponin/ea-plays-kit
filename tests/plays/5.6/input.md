# Play 5.6 — Sequence your national rollout into waves · fixture input

**Consumes:** A26, A28 rev.2, BB status register — from [`tests/progressa.md`](../../progressa.md).
...
placeholder in brackets above. The named input is A26, A28 rev.2, BB status register of `tests/progressa.md`. Paste
