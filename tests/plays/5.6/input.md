# Play 5.6 — Draft your closing one-page case for the minister · fixture input

**Consumes:** A29, A31, A8 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-comparator-evidence` · also runs: `cite-or-discard`, `ea-cost-case`
**Produces:** A29 rev.2 — Closing one-page case
...
placeholder in brackets above. The named input is A29, A31, A8 of `tests/progressa.md`. Paste
