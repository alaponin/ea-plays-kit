# Play 5.4 — expected output shape
...
The prompt of the play says: a one-page case under those four headings

## The safeguard, given back as the next action for the learner

The saving figures are directional, not a quotation — present them to motivate a properly costed business case. And verify every comparator claim against a real public source before it goes to cabinet; one unverifiable figure or example, caught, sinks the whole case.
