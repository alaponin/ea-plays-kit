# Play 5.7 — Draft your closing one-page case for the minister · fixture input

**Consumes:** A29, A31, A8 rev.2 — from [`tests/progressa.md`](../../progressa.md).
...
placeholder above. The named input is A29, A31, A8 rev.2 of `tests/progressa.md`; paste
