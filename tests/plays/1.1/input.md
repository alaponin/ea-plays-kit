# Play 1.1 — Diagnose your country's fragmentation symptoms · fixture input

**Consumes:** A0 §1 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `country-context-pack` · also runs: `cite-or-discard`
**Produces:** A1 — Fragmentation diagnostic
...
placeholder above. The named input is A0 §1 of `tests/progressa.md`; paste
