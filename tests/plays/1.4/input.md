# Play 1.4 — Translate an operating-model question into a business-IT joint agenda · fixture input

**Consumes:** A0 §3, A2 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-legal-context`
**Produces:** A4 — Joint business–IT agenda
...
placeholder above. The named input is A0 §3, A2 of `tests/progressa.md`; paste
