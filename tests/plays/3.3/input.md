# Play 3.3 — Draft the repository update policy · fixture input

**Consumes:** A16, A7 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-governance-drafter`
**Produces:** A18 — Repository update policy
...
placeholder above. The named input is A16, A7 of `tests/progressa.md`; paste
