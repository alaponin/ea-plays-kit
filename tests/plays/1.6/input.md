# Play 1.6 — Draft a phase-by-phase RACI for your country's EA programme · fixture input

**Consumes:** A0 §4, A4, A5 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-governance-drafter` · also runs: `ea-institution-mapper`
**Produces:** A6 — Phase RACI and role-gap list
...
placeholder above. The named input is A0 §4, A4, A5 of `tests/progressa.md`; paste
