# Play 3.1 — expected output shape
...
```
> **Artefact** A16 — EA repository structure · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** ea-governance-drafter v<version> · **Consumed** A13 · **Feeds** <play ids from workbook-chain.md>
...
a repository schema plus single-source rules

The prompt of the play says: a section-by-section schema plus a short 'single-source rules' list

## The safeguard, given back as the next action for the learner

Structure is the easy part. The repository only stays a single source if one named person maintains it and everyone is required to use it — design that rule and name that person, or the cleanest schema will still fracture into private copies.
