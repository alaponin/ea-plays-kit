# Play 3.4 — Draft your EA Board's Terms of Reference · fixture input

**Consumes:** A7, A0 §7 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-governance-drafter` · also runs: `ea-legal-context`
**Produces:** A7 rev.2 — EA Board ToR, standing version
...
placeholder above. The named input is A7, A0 §7 of `tests/progressa.md`; paste
