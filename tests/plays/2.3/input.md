# Play 2.3 — Turn a PAERA principle into a country-tailored principle card · fixture input

**Consumes:** A0 §7 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `paera-reference-check` · also runs: `ea-legal-context`
**Produces:** A11 — Principle card set
...
placeholder above. The named input is A0 §7 of `tests/progressa.md`; paste
