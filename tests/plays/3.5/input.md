# Play 3.5 — Build your architecture review gate checklist · fixture input

**Consumes:** A7 rev.2, A11, BB status register — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-governance-drafter` · also runs: `bb-landscape-check`
**Produces:** A19 — Review-gate checklist
...
placeholder in brackets above. The named input is A7 rev.2, A11, BB status register of `tests/progressa.md`. Paste
