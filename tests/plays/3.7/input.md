# Play 3.7 — Build your EA sustainment risk register · fixture input

**Consumes:** A20, A6 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-governance-drafter`
**Produces:** A21 — Sustainment risk register
...
placeholder in brackets above. The named input is A20, A6 of `tests/progressa.md`. Paste
