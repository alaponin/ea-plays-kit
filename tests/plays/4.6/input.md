# Play 4.6 — Sequence your roadmap into waves · fixture input

**Consumes:** A25, A3 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-method-runner`
**Produces:** A26 — Wave roadmap
...
placeholder above. The named input is A25, A3 of `tests/progressa.md`; paste
