# Play 1.5 — Map your country's existing initiatives against PAERA's five foundations · fixture input

**Consumes:** A0 §2, the initiatives list, A1 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `paera-reference-check` · also runs: `cite-or-discard`
**Produces:** A5 — PAERA foundation coverage map
...
placeholder in brackets above. The named input is A0 §2, the initiatives list, A1 of `tests/progressa.md`. Paste
