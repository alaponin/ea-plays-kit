# Play 4.7 — Run a gate decision on a real project · fixture input

**Consumes:** A26, A19, A7 rev.2, BB status register — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-method-runner` · also runs: `bb-landscape-check`
**Produces:** A27 — Gate decision paper
...
placeholder in brackets above. The named input is A26, A19, A7 rev.2, BB status register of `tests/progressa.md`. Paste
