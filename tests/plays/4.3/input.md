# Play 4.3 — Turn your Discovery brief into a ranked gap analysis · fixture input

**Consumes:** A23, A14 — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `ea-method-runner`
**Produces:** A14 rev.2 — Ranked gap analysis
...
placeholder above. The named input is A23, A14 of `tests/progressa.md`; paste
