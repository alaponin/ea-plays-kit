# Play 2.7 — Run a two-trap screen on a project proposal · fixture input

**Consumes:** A14, BB status register — from [`tests/progressa.md`](../../progressa.md).
**Primary skill:** `bb-landscape-check` · also runs: `bb-sourcing-researcher`
**Produces:** A15 — Two-trap screen
...
placeholder in brackets above. The named input is A14, BB status register of `tests/progressa.md`. Paste
