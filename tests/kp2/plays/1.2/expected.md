# KP2 play 1.2 — expected output shape
...
```
> **Artefact** B2 — Four-layer exchange map · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** gif-four-layer-map v<version> · **Consumed** A0 §1, A0 §9 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The output reflects only what you described — a 'Ready' on the legal layer means you told it a mandate exists, not that counsel has confirmed it.
