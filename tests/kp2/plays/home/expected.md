# KP2 home page — expected output shape
...
```
> **Artefact** B38 — Country storyboard · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** gif-foundation-drafter v<version> · **Consumed** B5, B28 · **Feeds** <play ids from workbook-chain-kp2.md>
...
a one-page no-framework-to-first-service storyboard mapped to the modules and phases

The prompt of the play says: the one-page storyboard

## The safeguard, given back as the next action for the learner

A storyboard is a plan to inspire and align, not a guarantee — keep the timeline honest (the foundation before the build, the first cross-ministry exchange in the second build phase, national coverage over years) and avoid promising a big-bang.
