# KP2 play 1.5 — expected output shape
...
```
> **Artefact** B5 — Use-Case Catalogue · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** country-context-pack v<version> · **Consumed** A0 §9, B3 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The prompt of the play says: the catalogue table plus the ranked first-wave shortlist

## The safeguard, given back as the next action for the learner

Readiness flags are first guesses from your description — the Legal and Semantic flags especially must be confirmed with the data owner and counsel.
