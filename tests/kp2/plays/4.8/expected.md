# KP2 play 4.8 — expected output shape
...
```
> **Artefact** B27 — Data-protection envelope · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** ea-legal-context v<version> · **Consumed** B5, B11 · **Feeds** <play ids from workbook-chain-kp2.md>
...
a lawful-basis finding, a draft Letter of Interest, and a data-protection-by-design checklist

The prompt of the play says: the lawful-basis finding, the draft Letter of Interest, and a data-protection-by-design checklist — with a clear flag if the exchange is not yet authorised by the decree

## The safeguard, given back as the next action for the learner

If the lawful-basis check flags NOT AUTHORISED, the exchange must not go live regardless of how well it is built — route it back to the legal layer to amend the decree or the Use-Case Catalogue.
