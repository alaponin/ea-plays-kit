# KP2 play 4.4 — expected output shape
...
```
> **Artefact** B23 — Semantic map · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** gif-semantic-map v<version> · **Consumed** B5, B22 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The prompt of the play says: the semantic map plus a list of every [confirm] to resolve

## The safeguard, given back as the next action for the learner

Identifier and code-list errors in a semantic map are the most dangerous defects in the whole framework — a wrong identifier silently merges two citizens' records.
