# KP2 play 3.5 — expected output shape
...
```
> **Artefact** B18 — Four Working Group charters · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** ea-governance-drafter v<version> · **Consumed** B15 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The prompt of the play says: four one-paragraph charters plus a note on where the groups overlap and must coordinate
