# KP2 play 4.7 — expected output shape
...
```
> **Artefact** B26 — X-Road service description and wiring checklist · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** gif-openapi-gen v<version> · **Consumed** B24, B6 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The prompt of the play says: the service-description notes, the access-control entries, and the test-call plan

## The safeguard, given back as the next action for the learner

Every member and subsystem identifier must be confirmed against the live X-Road registry before deployment — a wrong identifier does not error clearly, it silently routes nowhere or to the wrong place.
