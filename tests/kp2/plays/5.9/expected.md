# KP2 play 5.9 — expected output shape
...
```
> **Artefact** B36 — Document-consistency report · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** gif-consistency-check v<version> · **Consumed** B11, B19, B22 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The prompt of the play says: a contradiction table (finding / document A / document B / question) ordered by how damaging it would be if a reviewer found it

## The safeguard, given back as the next action for the learner

The cross-check finds drift; it must not resolve it — deciding whether the decree or the catalogue is correct is a legal and governance judgement a human owns.
