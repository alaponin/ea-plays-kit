# KP2 play 5.8 — expected output shape
...
```
> **Artefact** B35 — Bus-health summary and anomaly list · **Country** Progressa · **Sector** Education · **Built** <ISO date>
> **Skill** gif-bus-monitor v<version> · **Consumed** B33 · **Feeds** <play ids from workbook-chain-kp2.md>
...
The prompt of the play says: the health summary plus the prioritised investigate list

## The safeguard, given back as the next action for the learner

Confirm the logs are stripped of citizen personal data before they go into the prompt — the play monitors the traffic, never the cargo.
